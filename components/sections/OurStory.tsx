...
import { STORY_PARAGRAPHS } from "@/lib/constants/about";
...
export function OurStory({ heading = "Two decades of intent, not just construction", paragraphs = STORY_PARAGRAPHS }: OurStoryProps) {
  return (
